...
A new version ([v2.1](https://github.com/amattioc/vtl/tree/master/v2.1)) is currently being developed and the documentation is mainly html based and it is hosted in [github pages](https://sdmx-twg.github.io/vtl/) 
